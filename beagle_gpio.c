...
void pinMode(struct gpioID *singlePin,int pinID, const char *direction)
{
	...
	switch (pinID)
	{
		...
		case P8_8:
			strcpy(singlePin->PINNAME, "P8_8");
			strcpy(singlePin->GPIOID, "gpio2[3]");
			strcpy(singlePin->GPIOMUX, "gpmc_tm7");
			singlePin->GPIONUMBER=67;
			break;
			
		case P8_10:
			strcpy(singlePin->PINNAME, "P8_10");
			strcpy(singlePin->GPIOID, "gpio2[4]");
			strcpy(singlePin->GPIOMUX, "gpmc_tm6");
			singlePin->GPIONUMBER=68;
			break;
		...
		case P8_18:	
 			strcpy(singlePin->PINNAME, "P8_18");
			strcpy(singlePin->GPIOID, "gpio2[1]");
			strcpy(singlePin->GPIOMUX, "gpmc_ad21");
			singlePin->GPIONUMBER=65;
			break;
		...
		case P9_23:
			strcpy(singlePin->PINNAME, "P9_23");
	                strcpy(singlePin->GPIOID, "gpio1[17]");
                        strcpy(singlePin->GPIOMUX, "gpmc_a17");
                        singlePin->GPIONUMBER=49;
                        break;			
